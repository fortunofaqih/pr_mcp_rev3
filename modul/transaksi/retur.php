...
<<<<<<< HEAD
        echo "<script>alert('Berhasil! Stok telah dikembalikan.'); window.location='retur.php';</script>";
=======
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <button type="button" onclick="cetakRetur('<?= $h['id_retur'] ?>')" class="btn btn-sm btn-outline-primary py-0">
                ...
                <div class="modal-body p-4">
                    ...
                    <div class="row g-3 mb-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="id_barang" id="pilihBarang" class="form-select select2" required>
                                <option value=""></option> 
                                <?php
                                $sql_brg = "SELECT id_barang, nama_barang, satuan, stok_akhir FROM master_barang ORDER BY nama_barang ASC";
                                $brg = mysqli_query($koneksi, $sql_brg);
                                while($b = mysqli_fetch_array($brg)){
                                    echo "<option value='{$b['id_barang']}'>{$b['nama_barang']} (Stok: ".number_format($b['stok_akhir'], 0)." {$b['satuan']})</option>";
                                }
                                ?>
                            </select>
                        </div>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-12">
                            <div class="p-3 bg-light border-start border-warning border-4">
                                ...
                                <input type="number" name="qty_retur" class="form-control form-control-lg fw-bold" placeholder="0.00" step="0.01" min="0.01" required>
=======
...
>>>>>>> 94045b4816561a997cee91cfa3d1618d40e56612
                    ...
                    <div class="mb-3">
                        <label class="small fw-bold">YANG MENGEMBALIKAN</label>
                        <input type="text" name="pengembali" class="form-control" placeholder="Budiyono (Workshop)" required>
                    </div>
                    <div class="mb-0">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" name="simpan_retur" class="btn btn-sm btn-orange px-4">SIMPAN DATA</button>
                </div>
            </form>
        </div>
    </div>
...
<script>
    ...
    function cetakRetur(id) {
        // Membuka file cetak di tab baru
        const width = 800;
        const height = 600;
